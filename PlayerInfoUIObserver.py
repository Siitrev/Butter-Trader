...
class PlayerInfoUIObserver(UIObserver):
    def __init__(self, manager):
        ...
        money_label_rect = py.Rect((5, 5), (200,20))
        ...
        butter_label_rect = py.Rect((5, 35), (200,20))
        ...
        butter_capacity_label_rect = py.Rect((5, 65), (200,20))
    ...
    def update(self, object_id: str, value: str):
        if object_id == "money_label":
            self.money_label.set_text(f"Pieniadze: {value: 5.2f} PLN")
